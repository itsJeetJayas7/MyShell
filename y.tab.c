...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    STDOUT = 263,                  /* STDOUT  */
    STDIN = 264,                   /* STDIN  */
    APPEND_STDOUT = 265,           /* APPEND_STDOUT  */
    STDERR = 266,                  /* STDERR  */
    STDOUT_STDERR = 267,           /* STDOUT_STDERR  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_APPEND_STDOUT = 10,             /* APPEND_STDOUT  */
  YYSYMBOL_STDERR = 11,                    /* STDERR  */
  YYSYMBOL_STDOUT_STDERR = 12,             /* STDOUT_STDERR  */
...
static const yytype_uint8 yyrline[] =
{
      ...
      82,    83,    87,    98,   106,   107,   111,   119,   122,   125,
     129,   133,   142,   145
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NOTOKEN", "NEWLINE", "AMPERSAND", "STDOUT", "STDIN", "APPEND_STDOUT",
  "STDERR", "STDOUT_STDERR", "APPEND_STDOUT_STDERR", "$accept", "goal",
...
{
       4,    -8,    -8,     8,     4,    -8,     5,    -8,    -8,    -8,
      -8,     9,    -7,    10,    -8,    -8,    11,    12,    13,    14,
      15,    16,    -8,    17,    -8,    -8,    -8,    -8,    -8,    -8,
      -8,    -8,    -8
};
...
static const yytype_int8 yydefact[] =
{
       ...
       3,     0,    23,     9,     7,    22,     0,     0,     0,     0,
       0,     0,    14,     0,    12,    10,    16,    17,    19,    18,
      20,    21,     5
};
...
#line 87 "shell.y"
	...
	if (strcmp(g_current_single_command->arguments[0], "echo") == 0 && strchr((yyvsp[0].string), '?')) {
         ...
         expandWildCardsIfNecessary(strdup((yyvsp[0].string)));
       }
     }
#line 1230 "y.tab.c"
    break;
...
#line 1269 "y.tab.c"
  ...
  case 19: /* io_modifier: APPEND_STDOUT WORD  */
#line 125 "shell.y"
                       {
	g_current_command->out_file = strdup((yyvsp[0].string));
...
#line 1278 "y.tab.c"
  ...
  case 20: /* io_modifier: STDOUT_STDERR WORD  */
#line 129 "shell.y"
                       {
	g_current_command->out_file = strdup((yyvsp[0].string));
	g_current_command->err_file = strdup((yyvsp[0].string));
